...
export const allBusinesses: Business[] = [
    ...
    { id: '11', name: 'Gym Fuerte', category: 'Gimnasios', rating: 4.4, location: 'Norte', image: 'https://picsum.photos/300/300?random=11', dataAiHint: 'modern gym equipment', promoted: false, description: 'Equipamiento moderno y clases variadas.', latitude: 37.8000, longitude: -122.4300, address: 'Calle Fitness 1', phone: '555-1112', email: 'info@gymfuerte.com' },
    { id: '12', name: 'Cine Estrella', category: 'Cines', rating: 4.7, location: 'Centro', image: 'https://picsum.photos/300/300?random=12', dataAiHint: 'cinema movie screen', promoted: true, description: 'Los últimos estrenos en pantalla grande.', latitude: 37.7760, longitude: -122.4200, address: 'Plaza Cine 5', phone: '555-1113', email: 'info@cineestrella.com' },
];
